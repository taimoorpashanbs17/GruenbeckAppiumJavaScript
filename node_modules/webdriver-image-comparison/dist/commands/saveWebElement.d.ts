 ...
 */
export default function saveWebElement(methods: Methods, instanceData: InstanceData, folders: Folders, element: HTMLElement | WicElement, tag: string, saveElementOptions: SaveElementOptions): Promise<ScreenshotOutput>;
